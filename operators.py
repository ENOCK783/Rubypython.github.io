...
print("exponential of two operators" ,a**b)
...
#logical operator-used to access an expression(and,or,not)

e=10
print(f"is this statement true: {e>5} or {e<10}")
print(f"is this statement true: {e>5 and e<10}")
print(f"each statement is true then return false and viceversa:" ,(not(e>5 or e<10)))
